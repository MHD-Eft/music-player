...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->hideToolStripMenuItem1 = (gcnew System::Windows::Forms::ToolStripMenuItem());
			...
			// menuStrip1
			// 
			this->menuStrip1->Items->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) { this->playToolStripMenuItem });
			...
			// 
			this->playToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(4) {
				this->hideToolStripMenuItem,
					this->pauseToolStripMenuItem, this->hideToolStripMenuItem1, this->showToolStripMenuItem
			});
			this->playToolStripMenuItem->Name = L"playToolStripMenuItem";
			this->playToolStripMenuItem->Size = System::Drawing::Size(131, 20);
			this->playToolStripMenuItem->Text = L"Music Player Settings";
			// 
			// hideToolStripMenuItem
			// 
			this->hideToolStripMenuItem->Name = L"hideToolStripMenuItem";
			this->hideToolStripMenuItem->Size = System::Drawing::Size(180, 22);
			this->hideToolStripMenuItem->Text = L"Play";
			this->hideToolStripMenuItem->Click += gcnew System::EventHandler(this, &musicPlayer::hideToolStripMenuItem_Click);
			// 
			...
			this->pauseToolStripMenuItem->Click += gcnew System::EventHandler(this, &musicPlayer::pauseToolStripMenuItem_Click);
			// 
			// hideToolStripMenuItem1
			// 
			this->hideToolStripMenuItem1->Name = L"hideToolStripMenuItem1";
			this->hideToolStripMenuItem1->Size = System::Drawing::Size(180, 22);
			this->hideToolStripMenuItem1->Text = L"Hide";
			this->hideToolStripMenuItem1->Click += gcnew System::EventHandler(this, &musicPlayer::hideToolStripMenuItem1_Click);
			// 
			...
			this->showToolStripMenuItem->Click += gcnew System::EventHandler(this, &musicPlayer::showToolStripMenuItem_Click);
			// 
			// contextMenuStrip1
			// 
...
private: System::Void hideToolStripMenuItem1_Click(System::Object^ sender, System::EventArgs^ e) {
	hide();
}
